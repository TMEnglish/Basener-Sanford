/*
    Copyright William Basener. Used with permission.
*/
...
function runSimulation() {
    ...
    const results = {'percent_beneficial' : PctBeneficial,
                     'mutation_type' : mt,
                     'population_size' : PopSize,
                     'n_years' : numYears,
                     'n_rates' : numIncrements,
                     'birth_rates' : b,
                     'trajectory' : Psolution,
                     'growth_rates' : m,
                     'means': meanFitness,
                     'variances' : varianceFitness,
                     'mutation_probs' : probs,
                     'bin_width' : mDelta};
    const fs = require('fs');
