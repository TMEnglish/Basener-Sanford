...
This repository is a binder of Jupyter notebooks. If you want simply to view the notebooks, click on the `.ipynb` links above. (GitHub sporadically fails to load a notebook. If you encounter an error, keep trying.) If you want to work interactively with the notebooks on a JupyterHub server, then click on the icon below.
